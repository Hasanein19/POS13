    ...
    def _create_receipt_design_1(self):
        ...
        <div style="position: relative; display: block;">
            ...
            <div class="pos-receipt">
                ...
                <br/>
                <div><h2 t-esc='receipt.name' ></h2></div>
                <br/>
                        ...
                        <table style="width: 100%;">
                            ...
                            <td><div style="padding-top: 10px;padding-bottom: 10px;">
                                <span t-esc='line.product_name_wrapped[0]'/>
                                    <t t-if="line.selective_product_varient_ids">
                                        <div style="font-size: 10px">
                                            <t t-foreach="line.selective_product_varient_ids" t-as="selective_product">
                                                <li class="info"><t t-esc="selective_product.varient_name"/> <t t-if="selective_product.price">at
                                                    <t t-esc="widget.format_currency(selective_product.price,'Product Price')" /></t></li>
                                            </t>
                                        </div>
                                    </t>
            ...
            <table class='receipt-orderlines' style="font-size:13px;">
                ...
                <tr t-foreach="orderlines" t-as="orderline">
                    <td><div style="padding-top: 5px;padding-bottom: 5px;">
                          ...
                          <t t-if="orderline.selective_product_varient_ids">
                            <div style="font-size: 10px">
                                <t t-foreach="orderline.selective_product_varient_ids" t-as="selective_product">
                                    <li class="info"><t t-esc="selective_product.varient_name"/> <t t-if="selective_product.price">at
                                                    <t t-esc="widget.format_currency(selective_product.price,'Product Price')" /></t></li>
                                </t>
                            </div>
